...
class UserAgentRotatorMiddleware(UserAgentMiddleware):
    user_agent_list=["Mozilla/5.0 (Macintosh; Intel Mac OS X 11_5_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 Edg/92.0.902.84",
    ...
    def process_request(self,request,spider):
        ...
        try:
            ...
            request.headers.setdefault('user_agent',self.user_agent)
        except IndexError:

            logging.error("user agent cheack")
class TvSpiderMiddleware:
